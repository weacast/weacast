...
let gfs05 = {
  ...
  label: 'GFS - 0.5°',
  description: 'World-wide',
  attribution: 'Forecast data from <a href="https://www.emc.ncep.noaa.gov/index.php?branch=GFS">NCEP</a>',
  model: 'gfs',
  isDefault: true,
...
let arpege01 = {
  ...
  label: 'ARPEGE - 0.1°',
  description: 'Europe',
  attribution: 'Forecast data from <a href="https://www.meteofrance.com">Météo-France</a>',
  model: 'arpege',
  token: process.env.METEO_FRANCE_TOKEN,
  wcsBaseUrl: 'https://public-api.meteofrance.fr/public/arpege/1.0/wcs/MF-NWP-GLOBAL-ARPEGE-01-EUROPE-WCS/GetCoverage?SERVICE=WCS&version=2.0.1',
  bounds: [-32, 20, 42, 72],
  origin: [-32, 72],
  size: [741, 521],
  resolution: [0.1, 0.1],
...
let arome025 = {
  ...
  model: 'arome',
  token: process.env.METEO_FRANCE_TOKEN,
  wcsBaseUrl: 'https://public-api.meteofrance.fr/public/arome/1.0/wcs/MF-NWP-HIGHRES-AROME-0025-FRANCE-WCS/GetCoverage?SERVICE=WCS&version=2.0.1',
  bounds: [-8, 38, 12, 53],
  origin: [-8, 53],
  size: [801, 601],
...
let arome01 = {
  ...
  model: 'arome',
  token: process.env.METEO_FRANCE_TOKEN,
  wcsBaseUrl: 'https://public-api.meteofrance.fr/public/arome/1.0/wcs/MF-NWP-HIGHRES-AROME-001-FRANCE-WCS/GetCoverage?SERVICE=WCS&version=2.0.1',
  bounds: [-8, 38, 12, 53],
  origin: [-8, 53],
  size: [2001, 1501],
